...
class CreateReportMaterialSummariesTable extends Migration
{
    public function up(): void
    {
        if ($this->db->tableExists('ReportMaterialSummaries')) {
            return;
        }
    ...
    {
        $this->forge->dropTable('ReportMaterialSummaries', true);
    }
}
