...
class HeavyEquipmentCategoriesSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $rows = [
            ...
            ['name' => 'Boring Machine', 'slug' => 'boring-machine', 'sort_order' => 2, 'is_active' => 1],
            ['name' => 'Crane Service', 'slug' => 'crane', 'sort_order' => 3, 'is_active' => 1],
            ['name' => 'Vibro Hammer', 'slug' => 'vibro-hammer', 'sort_order' => 4, 'is_active' => 1],
            ['name' => 'Truck Mixer', 'slug' => 'truck-mixer', 'sort_order' => 5, 'is_active' => 1],
            ['name' => 'Excavator', 'slug' => 'excavator', 'sort_order' => 6, 'is_active' => 1],
            ['name' => 'Loader', 'slug' => 'loader', 'sort_order' => 7, 'is_active' => 1],
            ['name' => 'Dump Truck', 'slug' => 'dump-truck', 'sort_order' => 8, 'is_active' => 1],
